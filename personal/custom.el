...
(custom-set-variables
 ...
 '(package-selected-packages
   '(svelte-mode arduino-mode ag git-modes undo-tree typescript-mode copilot pyvenv nginx-mode gnu-elpa-keyring-update php-mode pyenv-mode lsp-ui lsp-mode scss-mode flycheck-plantuml plantuml-mode graphql-mode csv-mode htmlize dockerfile-mode markdown-mode smex ido-completing-read+ flx-ido cython-mode wcheck-mode jinja2-mode multi-term helm-swoop smart-mode-line workgroups2 yaml-mode web-mode json-mode rainbow-mode elisp-slime-nav rainbow-delimiters coffee-mode company helm-projectile helm counsel swiper exec-path-from-shell zop-to-char zenburn-theme which-key volatile-highlights super-save smartrep smartparens operate-on-number move-text magit projectile imenu-anywhere hl-todo guru-mode gitignore-mode gitconfig-mode git-timemachine gist flycheck expand-region editorconfig easy-kill diminish diff-hl discover-my-major cyberpunk-theme crux browse-kill-ring beacon ace-window))
 ...
 '(projectile-project-root-files-bottom-up '(".projectile" ".hg" ".fslckout" ".bzr" "_darcs"))
 '(projectile-project-root-files-top-down-recurring '(".git" ".svn" "CVS"))
